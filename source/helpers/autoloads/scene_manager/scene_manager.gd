...
@onready var hint_ref = %hint
@onready var finished_ref = %finished
...
func tween_load_visibility(_start_alpha, final_alpha) -> void:
...
func finish_switch(scene_path = null) -> void:
	...
	if scene_path != GlobalRefs.main_menu_path:
